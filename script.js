...
function title(){
    ...
    title.textContent = 'Кошки VS Мышки'
    div.append(title)
}
title()
...
function lose(){
    ...
    if (cat.style.top == mouse.style.top){
        ...
        title.innerHTML = 'Ваш результат ' + setTimer()
